...
def line_profile(data: np.ndarray,
    ...
    ax.plot(mean_data[:,0], label=f'{field_label}x$', marker='o')
    ax.plot(mean_data[:,1], label=f'{field_label}y$', marker='o')
    ax.plot(mean_data[:,2], label=f'{field_label}z$', marker='o')
